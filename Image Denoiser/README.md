This project smoothes noisy .pgm image files. The input file path, as well as the desired stopping condition is modified in runADMM.m. The stopping condition is 
